...
pet(cat3, calm, no_shed, small, youth, trained).
pet(cat4, calm, no_shed, small, youth, no_trained).
...
pet(cat9, calm, no_shed, large, youth, trained).
pet(cat10, calm, no_shed, large, youth, no_trained).
...
pet(cat15, calm, shed, small, youth, trained).
pet(cat16, calm, shed, small, youth, no_trained).
...
pet(cat21, calm, shed, large, youth, trained).
pet(cat22, calm, shed, large, youth, no_trained).
...
pet(cat27, neutral, no_shed, small, youth, trained).
pet(cat28, neutral, no_shed, small, youth, no_trained).
...
pet(cat33, neutral, no_shed, large, youth, trained).
pet(cat34, neutral, no_shed, large, youth, no_trained).
...
pet(cat39, neutral, shed, small, youth, trained).
pet(cat40, neutral, shed, small, youth, no_trained).
...
pet(cat45, neutral, shed, large, youth, trained).
pet(cat46, neutral, shed, large, youth, no_trained).
...
pet(cat51, high_energy, no_shed, small, youth, trained).
pet(cat52, high_energy, no_shed, small, youth, no_trained).
...
pet(cat57, high_energy, no_shed, large, youth, trained).
pet(cat58, high_energy, no_shed, large, youth, no_trained).
...
pet(cat63, high_energy, shed, small, youth, trained).
pet(cat64, high_energy, shed, small, youth, no_trained).
...
pet(cat69, high_energy, shed, large, youth, trained).
pet(cat70, high_energy, shed, large, youth, no_trained).
...
pet(dog3, calm, no_shed, small, youth, trained).
pet(dog4, calm, no_shed, small, youth, no_trained).
...
pet(dog9, calm, no_shed, large, youth, trained).
pet(dog10, calm, no_shed, large, youth, no_trained).
...
pet(dog15, calm, shed, small, youth, trained).
pet(dog16, calm, shed, small, youth, no_trained).
...
pet(dog21, calm, shed, large, youth, trained).
pet(dog22, calm, shed, large, youth, no_trained).
...
pet(dog27, neutral, no_shed, small, youth, trained).
pet(dog28, neutral, no_shed, small, youth, no_trained).
...
pet(dog33, neutral, no_shed, large, youth, trained).
pet(dog34, neutral, no_shed, large, youth, no_trained).
...
pet(dog39, neutral, shed, small, youth, trained).
pet(dog40, neutral, shed, small, youth, no_trained).
...
pet(dog45, neutral, shed, large, youth, trained).
pet(dog46, neutral, shed, large, youth, no_trained).
...
pet(dog51, high_energy, no_shed, small, youth, trained).
pet(dog52, high_energy, no_shed, small, youth, no_trained).
...
pet(dog57, high_energy, no_shed, large, youth, trained).
pet(dog58, high_energy, no_shed, large, youth, no_trained).
...
pet(dog63, high_energy, shed, small, youth, trained).
pet(dog64, high_energy, shed, small, youth, no_trained).
...
pet(dog69, high_energy, shed, large, youth, trained).
pet(dog70, high_energy, shed, large, youth, no_trained).
